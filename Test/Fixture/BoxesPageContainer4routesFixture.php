...
App::uses('Box4routesFixture', 'Pages.Test/Fixture');
App::uses('PageContainer4routesFixture', 'Pages.Test/Fixture');
 ...
 */
class BoxesPageContainer4routesFixture extends BoxesPageContainerFixture {
 ...
 */
	public function init() {
		$fixture = new Box4routesFixture();
		$fixture->setRecords();
		$this->_boxes = $fixture->records;

		$fixture = new PageContainer4routesFixture();
		$fixture->setRecords();
